<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MenShirts.aspx.cs" Inherits="MyEshoppingWebsitee.MenShirts" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>MenShirts</title>
  ...
  <h2>Men Shirts</h2> 
    ...
    <div class="panel panel-primary">
      ...
      <asp:TextBox ID="txtFilterGrid1Record"  runat="server"
              placeholder="Search Products...." AutoPostBack="true" OnTextChanged="txtFilterGrid1Record_TextChanged"
               ></asp:TextBox>
      <br />
      <hr />
