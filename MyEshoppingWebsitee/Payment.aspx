<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Payment.aspx.cs" Inherits="MyEshoppingWebsitee.Payment" %>
            ...
            <ul class="nav nav-tabs">
             ...
             <div class="tab-content">
                                <div id="PlaceNPay" class="tab-pane fade in active">
                                    ...
                                    <asp:Button ID="BtnPlaceNPay" CssClass=" btn btn-info" Font-Size="Large" ValidationGroup="PaymentPage" runat="server" OnClick="BtnPlaceNPay_Click" Text="Checkout »" />
                                </div>
                                <div id="EasyPaisa" class="tab-pane fade">
                                    ...
                                    <!--  <asp:Button ID="btnEasyPaisa" CssClass=" btn btn-success" Font-Size="Large" runat="server" Text="Pay with EasyPaisa »" /> -->
                                </div>
                                <div id="JazzCash" class="tab-pane fade">
                                    ...
                                    <!-- <asp:Button ID="btnJazzCash" CssClass="btn btn-danger" runat="server" Font-Size="Large" Text="Pay with JazzCash »" /> -->
                                </div>
                                <div id="Div1" class="tab-pane fade">
                                    <h3 class="center1">Cash on Delivery - Coming Soon</h3>
                                    <!-- <asp:Button ID="btnCOD" CssClass="btn btn-primary" runat="server" Text="CheckOut »" Font-Size="Large" /> -->
                                </div>
                            </div>
        </div>
